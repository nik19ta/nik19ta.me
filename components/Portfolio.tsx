...
const Portfolio: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setPortfolio([
      { id: "1", url: portfolio_image, title: "OWSUP", sub_title: "Сервис для продавцов на ozon, wildberries" },
      { id: "2", url: portfolio_image, title: "OWSUP", sub_title: "Сервис для продавцов на ozon, wildberries" },
      { id: "3", url: portfolio_image, title: "OWSUP", sub_title: "Сервис для продавцов на ozon, wildberries" },
      { id: "4", url: portfolio_image, title: "OWSUP", sub_title: "Сервис для продавцов на ozon, wildberries" }
    ])
    setActiveTab("1")
  }, [])
  ...
  return (
    <div id="portfolio" className={styles.portfolio_screen}>
        ...
        {portfolio.length > 0 &&
          portfolio.map((element) => (
            <div key={element.id} className={styles.portfolio_cards__item}>
              <img src={element.url.src} className={styles.portfolio_cards__item_photo} alt="" />
      ...
      <div className={styles.portfolio_screen__show_more_container}>
        <button className={styles.portfolio_screen__show_more}>
          Показать еще
        </button>
      </div>
    </div>
